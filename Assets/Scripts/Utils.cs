...
public static class Utils {
	...
	/// <param name="step">The steepness of the steps between values in the perlin noise</param>
	/// <param name="scale">How much to scale the values generated by (originally 0-1)</param>
