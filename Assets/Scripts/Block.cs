...
public class Block : MonoBehaviour {
    ...
    public BlockGroup BlockGroup { get => transform.parent.GetComponent<BlockGroup>( ); }
    public bool IsBoomBlock { get => BlockType != BlockType.NORMAL; }
    public Sprite Sprite { get => spriteRenderer.sprite; }
    public int MinoIndex { get => minoIndex; set => minoIndex = value; }
