...
public class BlockGroup : MonoBehaviour {
    ...
    protected bool IsAtDestination { get => Utils.CompareVectors(moveTo, transform.position) && Utils.CompareDegreeAngleVectors(rotateTo, transform.eulerAngles); }
    ...
    protected bool Move (Vector3 direction) {
        ...
        for (int i = Size - 1; i >= 0; i--) {
            ...
            // Vector3 currPosition = moveTo + this[i].transform.localPosition;
    ...
    protected bool Rotate (float degRotation) {
        ...
        for (int i = Size - 1; i >= 0; i--) {
            ...
            // Vector3 toPosition = Utils.Vect3Round(Utils.RotatePositionAroundPivot(currPosition, moveTo, rotateTo.z + degRotation));
        }
